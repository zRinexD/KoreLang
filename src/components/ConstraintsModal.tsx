...
import { X, ShieldCheck, CheckCircle, Type, Regex, ArrowRightToLine, ArrowDownAZ, Globe } from 'lucide-react';
...
const ConstraintsModal: React.FC<ConstraintsModalProps> = ({ isOpen, onClose, constraints, onUpdateConstraints, scriptConfig, isScriptMode = false }) => {
